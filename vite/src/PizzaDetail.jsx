...
export default function PizzaDetail() {
  ...
  if (!pizza) {
    return (
      <>
        <Header />
        <main className="menu-contain" style={{ padding: 24 }}>
          <h1>Pizza Not Found</h1>
          <Link to="/">Back to Pizza Menu</Link>
        </main>
      </>
    );
  }
  return (
    <>
      <Header />
      <main className="menu-contain" style={{ padding: 24 }}>
        <Link to="/" style={{ display: 'inline-block', marginBottom: 16 }}>&larr; Back to Pizza Menu</Link>
        <div className="menu-item" style={{ maxWidth: 400, margin: '0 auto' }}>
